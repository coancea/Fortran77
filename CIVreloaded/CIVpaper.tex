...
This paper does not contribute to this stage, but uses  
uses previously developed techniques~\cite{VEG}.
...
%
In practice, they have been found to scale better than analysis
based on pairwise accesses.
% 
...
represent the empty set with an interval in which the lower bound
...
%
            ...
            in this paper were reported by~\cite{CosPLDI}, however
            the compiler techniques that achieve these results were 
...
in Figure~\ref{fig:codeActforCorrec}(a) is to

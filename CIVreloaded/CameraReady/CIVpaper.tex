...
civ@5=\mymath{\gamma}(civ@4,civ@1)
            ...
            (a)
\end{colorcode}
\hspace{2ex}\includegraphics[width=1\textwidth]{\Figures/CorrecRWsets.eps}
\end{minipage}
...
\begin{colorcode}
      ...
      at Gated-SSA Path, 
         ...
         Loop Levels
\end{colorcode}
\includegraphics[width=1.15\textwidth]{\Figures/VEG_CORREC.eps}
\begin{colorcode}
                (b)
\end{colorcode}
\end{minipage}
...
\begin{figure}[t]
	...
	{   
   		\subfigure[$\mbox{~~~~~~~~~~~~~~~~}$]{ 
			...
			\includegraphics[width=.38\textwidth]{\Figures/ROio_USR_EXTEND_do500.eps}
	  	}
	} & {  \hspace{-22ex}
		\subfigure[$\mbox{~}$]{
          	\label{fig:VegEXTEND} 
			\includegraphics[width=.23\textwidth]{\Figures/VEG_EXTEND.eps}
	  	}
	}
...
\includegraphics[width=1.1\textwidth]{\Figures/VEG_TREE.eps}\\
...
\begin{minipage}{1.2\columnwidth}
    \includegraphics[width=0.55\textwidth]{\Figures/EmpRes/BenchParRes.eps} 

      {\bf~~~~~~~~~~~~~~~~~~~~~~~~~~~~~(a)} \vspace{2ex}

    \includegraphics[width=0.55\textwidth]{\Figures/EmpRes/LoopScalRes.eps}
      
      {\bf~~~~~~~~~~~~~~~~~~~~~~~~~~~~~(c)}\vspace{1ex}

\end{minipage}
\begin{minipage}{0.9\columnwidth}
    \includegraphics[width=0.75\textwidth]{\Figures/EmpRes/LoopParRes.eps} 

      {\bf~~~~~~~~~~~~~~~~~~~~~~~~~~~~~(b)}\vspace{2ex}

   \includegraphics[width=0.75\textwidth]{\Figures/EmpRes/TrackScal.eps}

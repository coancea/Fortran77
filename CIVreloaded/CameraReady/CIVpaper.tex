...
\authorinfo{Lawrence Rauchwerger}
           {Department of Computer Science and Eng.\\Texas A \& M University}
           {rwerger@cs.tamu.edu}
...
\begin{colorcode}
      ...
      at Gated-SSA Path, 
         ...
         Loop Levels
\end{colorcode}
\includegraphics[width=1.15\textwidth]{\Figures/VEG_CORREC}
\begin{colorcode}
                (b)
\end{colorcode}
\end{minipage}
...
%, but will not prove flow independence. 
%
...
Similarly, we would like to overestimate the write accesses %{\sc civ}  
...
\begin{figure}[t]
	...
	{   
   		\subfigure[$\mbox{~~~~~~~~~~~~~~~~}$]{ 
			...
			\includegraphics[width=.38\textwidth]{\Figures/ROio_USR_EXTEND_do500}
	  	}
	} & {  \hspace{-22ex}
		\subfigure[$\mbox{~}$]{
          	\label{fig:VegEXTEND} 
			\includegraphics[width=.23\textwidth]{\Figures/VEG_EXTEND}
	  	}
	}
